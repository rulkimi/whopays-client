...
export default function ReceiptCard({
	...
	const maxAvatars = 5;
	const showMore = receipt.friends.length > maxAvatars;
	const visibleFriends = showMore ? receipt.friends.slice(0, maxAvatars) : receipt.friends;
	const moreCount = receipt.friends.length - maxAvatars;
